        ...
        <>
            <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
                <div class="relative py-3 sm:max-w-xl sm:mx-auto">
                    <div
                        class="absolute inset-0 bg-[#e0e7ff] -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
                    </div>
                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <div class="divide-y divide-gray-200">
                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <a href="/forget"> <p className="mt-2 cursor-pointer text-blue-500 hover:text-blue-600">Forgot password?</p></a>
                                    <div class="relative">
                                        <button class="bg-[#4f46e5] text-white rounded-md px-2 py-1">Log in</button>
                                    </div>
                                </div>
                            </div>
                        </div>
